    ...
    getData = () => {
        ...
        axios({
                ...
                "headers": {
                    ...
                    "x-rapidapi-key": "5319729c96msh884c60157baad7ap1baca8jsn2a14656621e9",
                    "useQueryString": true
                }
            })
            .then((response) => {
    ...
    render() {
        return ( <
                ...
                /a> {
                    ...
                    className = "nav-item text-nowrap d-none d-sm-none d-sm-block" > Loading... < /div> : <
                ...
                a target = "_blank"
                rel = "noopener noreferrer"
                href = "https://coinpaprika.com/" > coinpaprika < /a> <
                /caption> <
                ...
                tbody > {
                    this.state.ccData.map((data, key) => {
                        return ( <
                            ...
                            td > < a target = "_blank"
                            rel = "noopener noreferrer"
                            href = { "https://coinpaprika.com/coin/" + data.id } > { data.name } < /a></td >
                            <
                            td > $ {
                                (data.quotes.USD.price).toFixed(2) } < /td> <
                            td > $ {
                                (data.quotes.USD.market_cap).toLocaleString("fr-CH") } < /td> <
                            /tr>
                        )
                    })
                } <
